...
<form autocomplete="off" method=post action="<?= htmlentities($_SERVER["PHP_SELF"], ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML5, "UTF-8") ?>">
	<p>
...
<footer style="display: flex; text-align:center; width:50rem; height:auto; margin: auto;">
	<p class="foot-text">Author: Daniil Sorokin</p>
	<p class="foot-text">Software: Stephan Soller</p>
	<p class="foot-text"><a href="https://github.com/arkanis/simple-chat" target="_blank">GitHub</a></p>
	<p class="foot-text">Any Questions? <a href="mailto:dancho321sorokin@gmail.com" target="_blank">Email me!</a></p>
</footer>
